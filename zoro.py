...
from makeString import formatWords, formMultiplyString

size = 22

file1 = open("/Users/marcobarreirinhas1/Programs/Python/words.txt", "w")
file2 = open("/Users/marcobarreirinhas1/Programs/Python/words2.txt", "w")
